...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('student.attendance.report', ['class_id' => $class->class_id, 'month' => $month->format('Y-m')]) }}" class="btn btn-info text-white">
        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-4">
                        <form action="{{ route('student.attendance.report') }}" method="GET" class="form-inline justify-content-center">
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="alert alert-info">
                            No attendance records found for this student in {{ $month->format('F Y') }}.
                        </div>
                    @endif
                </div>
            </div>
