                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        ...
                        @error('class_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">Example: Grade 1, Class 10, etc.</small>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        @error('section')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="form-text text-muted">Example: A, B, Red, etc.</small>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('class_teacher_id') is-invalid @enderror" id="class_teacher_id" name="class_teacher_id">
                        ...
                        @foreach($teachers as $teacher)
                            <option value="{{ $teacher->teacher_id }}" {{ old('class_teacher_id') == $teacher->teacher_id ? 'selected' : '' }}>
                    ...
                    @error('class_teacher_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">The teacher who will be responsible for this class.</small>
                </div>
